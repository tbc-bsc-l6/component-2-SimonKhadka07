...
<body class="bg-gray-100">
    <div class="flex items-center justify-center h-screen">
        <div class="text-center">
            <h1 class="text-4xl font-bold mb-6">Welcome to My Laravel App</h1>
            <p class="mb-6">This is a simple Laravel application with authentication and admin features.</p>
